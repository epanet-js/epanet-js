...
This app depends on separate workspace packages: `@epanet-js/ejsdb`, the persistence / on-disk file-format layer; `@epanet-js/i18n`, the shared i18n machinery this app and the model builder both consume (see [translation.md](./guidelines/translation.md)); `@epanet-js/map`, the map engine, rendering contracts, symbology, and data sources; and `@epanet-js/simulation`, the results-reader contract.
