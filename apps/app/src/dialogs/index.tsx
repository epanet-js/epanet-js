...
import { CollectionsPaywallConnector } from "src/dialogs/paywall/collections-connector";
...
export const Dialogs = memo(function Dialogs() {
  ...
  if (dialog.type === "featurePaywall") {
    ...
    if (dialog.feature === "selectionSets") {
      return <CollectionsPaywallConnector onClose={onClose} />;
    }
