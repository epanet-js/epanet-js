...
export const useDeleteSelection = () => {
  ...
  const deleteSelectionNew = useDeleteSelectionNew();
  const deleteSelectionDeprecated = useDeleteSelectionDeprecated();
  return isMultiCpSelectionOn ? deleteSelectionNew : deleteSelectionDeprecated;
};

const useDeleteSelectionDeprecated = () => {
