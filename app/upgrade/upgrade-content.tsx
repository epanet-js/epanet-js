...
import { Button, StyledSwitch, StyledThumb } from "src/components/elements";
import {
  ...
  return (
    <div className="text-center p-6">
      ...
      <h1 className="mt-4 text-xl font-semibold text-gray-900 dark:text-white">
        {translate("planChangesFromSupport")}
      </h1>
...
// Copy all the plan components from the original upgrade dialog
