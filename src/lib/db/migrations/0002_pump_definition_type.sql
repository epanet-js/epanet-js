...
-- Recreate with updated definition_type CHECK constraint
CREATE TABLE pumps (
  ...
  length                   REAL,
  initial_status           TEXT,
  definition_type          TEXT NOT NULL CHECK (definition_type IN ('power','designPointCurve','standardCurve','curveId')),
  power                    REAL,
  speed                    REAL,
