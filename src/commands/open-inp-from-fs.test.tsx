...
// TODO: Fix tests after EPS spike - needs eps-store mock
it.skip("doesnt create model when coordinates not supported", async () => {
...
// TODO: Fix tests after EPS spike - needs eps-store mock
it.skip("shows warning when using unsupported features", async () => {
