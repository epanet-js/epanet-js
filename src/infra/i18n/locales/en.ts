...
export const translations = {
  ...
  experimentalLanguage:
    "This language is in beta. Please try it and contact support if you notice any inaccuracies.",
  exit: "Exit",
  ...
  onboardingStartValve:
    "Click on an existing node to draw a valve, or click anywhere to start with a new junction.",
  onboardingStartValveEmpty: "Click anywhere to start drawing a valve.",
  onboardingCtrlValve:
    "Hold ${1} and click to end and start a new valve immediately.",
  onboardingDrawValve:
    "Click to define vertices. Finish at a junction or double-click to add one.",
  ...
  smallScreenExplain:
    "It looks like you're trying to access the app from a smaller device. This application is currently in preview mode for this screen size, and some editing features may not be available.",
  hereYourOptions: "Here are your options",
  continueAnyway: "Continue Anyway",
  continueAnywayExplain:
    "You can proceed, but the experience may not be ideal, and some features might be missing.",
