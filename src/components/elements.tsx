...
export function SiteIcon({ }: React.HTMLAttributes<SVGElement>) {
  ...
  <path d="m19.788 12.485c-0.24626-0.39251-0.54271-0.7499-0.79621-1.1196-1.5-2.1875-3-3.875-3-3.875s-1.5 1.6875-3 3.875c-0.75 1.0938-1.5 2.3125-2.0625 3.5078-0.28781 0.6116-0.51733 1.1258-0.68185 1.7052z" fill="#EDF0F2"></path>
</svg>
  )
}
