...
describe("PatternLabelInput", () => {
  ...
  it("renders input with given value", () => {
    render(
      <ul>
        <PatternLabelInput {...defaultProps} value="EXISTING" />
      </ul>,
    );
  ...
  it("auto-focuses the input", () => {
    render(
      <ul>
        <PatternLabelInput {...defaultProps} />
      </ul>,
    );
  ...
  it("calls onCommit with entered text on Enter", async () => {
    ...
    render(
      <ul>
        <PatternLabelInput {...defaultProps} onCommit={onCommit} />
      </ul>,
    );
  ...
  it("calls onCancel on Escape", async () => {
    ...
    render(
      <ul>
        <PatternLabelInput {...defaultProps} onCancel={onCancel} />
      </ul>,
    );
