...
import { ParseInpOptions } from "./parse-inp-with-controls";
import {
  RowParser,
  ignore,
  parseDemand,
  ...
  unsupported,
  parseTimeSetting,
  parseControlsWithControls,
  parseRulesWithControls,
  parseEnergy,
  parseEmitter,
  parseReaction,
} from "./row-parsers";
...
const buildSectionParserDefinitions = (): SectionParserDefinition[] => [
  ...
  { names: ["CONTROLS"], parser: parseControlsWithControls },
  { names: ["PUMPS", "PUMP"], parser: parsePump },
  { names: ["RULES"], parser: parseRulesWithControls },
...
export const readInpDataWithControls = (
  inp: string,
