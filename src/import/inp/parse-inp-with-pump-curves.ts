...
import { buildModelWithPumpCurves } from "./build-model-with-pump-curves";
...
export const parseInpWithPumpCurves = (
  inp: string,
  ...
  const { hydraulicModel, modelMetadata } = buildModelWithPumpCurves(
    inpData,
    issues,
    safeOptions,
  );
