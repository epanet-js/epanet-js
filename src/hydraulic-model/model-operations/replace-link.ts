...
import { addLink, addLinkWithPrecision } from "./add-link";
...
export const replaceLinkWithPrecision: ModelOperation<
  InputDataWithPrecision
> = (
  hydraulicModel,
  {
    sourceLinkId,
  ...
  const addLinkResult = addLinkWithPrecision(hydraulicModel, {
    link: newLink,
    startNode,
    endNode,
    startPipeId,
  ...
  const reconnectedCustomerPoints =
    sourceLinkAsset.type === "pipe"
      ? reconnectCustomerPointsWithPrecision(
          hydraulicModel,
          sourceLinkId,
          newLink,
          startNode,
...
const reconnectCustomerPointsWithPrecision = (
  hydraulicModel: HydraulicModel,
  sourceLinkId: AssetId,
  newLink: LinkAsset,
  startNode: NodeAsset,
